...
[_QWERTY] = LAYOUT_all(
   ...
   KC_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,   RGB_TOG, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,   RGB_MOD, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT ,
...
<<<<<<< HEAD:keyboards/montsinger/rebound/rev4/keymaps/vial/keymap.c
=======
...
>>>>>>> upstream/vial:keyboards/montsinger/rebound/rev4/keymaps/via/keymap.c
