...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT( \
        ...
        KC_LCTL, KC_LALT, KC_LGUI,     MO(2), KC_SPC, KC_SPC,       KC_RGUI, KC_RALT, KC_RCTL  \
    ),
    ...
    [1] = LAYOUT( \
        ...
        KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MINS, KC_EQL,  KC_SLSH, KC_TRNS, \
    ...
    [2] = LAYOUT( \
        ...
        KC_TRNS,          KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_BSLS, KC_TRNS, \
